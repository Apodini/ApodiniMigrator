...
enum HandleArrayDidEncounterCircle {}
...
func handleArray(_ node: Node<ReflectionInfo>) throws -> Tree<ReflectionInfo> {
    let typeInfo = node.value.typeInfo

    guard typeInfo._mangledName == .array,
