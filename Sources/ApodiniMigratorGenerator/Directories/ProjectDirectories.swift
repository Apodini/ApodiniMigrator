...
public struct ProjectDirectories {
    ...
    /// Asserts that a given package contains `allDirectories`, a.k.a the package was generated by `ApodiniMigrator`
    func assertDirectories() {
        assert(allDirectories.allSatisfy { $0.exists }, "The specified package is malformed")
    }
